  ...
  return (
    <SafeAreaView className="flex-1 bg-white dark:bg-slate-900" edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 24 }} showsVerticalScrollIndicator={false}>
          <View className="w-full items-center mt-6 mb-2 z-10 relative">
            <ThemeToggle />
          </View>

          <View className="w-full px-4 items-center mb-6">
            <View className="w-full bg-blue-50 dark:bg-slate-900 rounded-[40px] overflow-hidden pt-8 mb-4 shadow-sm shadow-slate-200 dark:shadow-slate-900 border border-slate-100 dark:border-slate-800 transition-colors duration-1000">
